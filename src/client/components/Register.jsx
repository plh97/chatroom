    ...
    return (
      <form onSubmit={this.handleSubmit} className="register-form">
        ...
        <div className="userName">
          <Icon className="prefix" type="user" style={{
            fontSize: 13
          }}/>
          <input id="userName" ref={(c) => this._input = c} onChange={this.onUserNameChange} placeholder="用户名"/>
        </div>
        <div className="passWord">
          <Icon className="prefix" type="lock" style={{
            fontSize: 13
          }}/>
