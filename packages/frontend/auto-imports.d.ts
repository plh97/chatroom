...
declare global {
  ...
  const ContentComponent: typeof import("./src/components/ContentComponent")["ContentComponent"];
  const ControlComponent: typeof import("./src/components/ControlComponent")["ControlComponent"];
  ...
  const LayoutComponent: typeof import("./src/components/LayoutComponent")["LayoutComponent"];
  const Link: typeof import("react-router-dom")["Link"];
  const LoginPage: typeof import("./src/views/LoginPage")["LoginPage"];
  const MessageComponent: typeof import("./src/components/MessageComponent")["MessageComponent"];
  const NavLink: typeof import("react-router-dom")["NavLink"];
  const Navigate: typeof import("react-router-dom")["Navigate"];
  const Outlet: typeof import("react-router-dom")["Outlet"];
  const RegisterPage: typeof import("./src/views/RegisterPage")["RegisterPage"];
  const RoomItemComponent: typeof import("./src/components/RoomItemComponent")["RoomItemComponent"];
  const RoomPage: typeof import("./src/views/RoomPage")["RoomPage"];
  const Route: typeof import("react-router-dom")["Route"];
  const Routes: typeof import("react-router-dom")["Routes"];
  const SidebarComponent: typeof import("./src/components/SidebarComponent")["SidebarComponent"];
