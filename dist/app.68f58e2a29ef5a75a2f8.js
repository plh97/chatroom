...
var header = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					{ className: 'title' },
					group.group_name == null ? _react2.default.createElement(
						'h1',
						null,
						'\u623F\u95F4\u4E0D\u5B58\u5728'
					) : group.group_name == '' ? _react2.default.createElement(
						'h1',
						null,
						'github chat'
					) : _react2.default.createElement(
						...
						group.group_name + '(' + group.memberList.filter(function (e) {
							return onlineUsers.indexOf(e.user_id) >= 0;
						}).length + '/' + group.memberList.length + ')\u4EBA',
