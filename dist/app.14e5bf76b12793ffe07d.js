...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__required__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__whitespace__ = __webpack_require__(458);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__type__ = __webpack_require__(459);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__range__ = __webpack_require__(460);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__enum__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pattern__ = __webpack_require__(462);
...
var emoji = exports.emoji = '😀 😃 😄 😁 😆 😅 😂 🤣 😊 😇 🙂 🙃 😉 😌 😍 😘 😗 😙 😚 😋 😜 😝 😛 🤑 🤗 🤓 😎 🤡 🤠 😏 😒 😞 😔 😟 😕 🙁 ☹️ 😣 😖 😫 😩 😤 😠 😡 😶 😐 😑 😯 😦 😧 😮 😲 😵 😳 😱 😨 😰 😢 😥 🤤 😭 😓 😪 😴 🙄 🤔 🤥 😬 🤐';
var colorList = exports.colorList = ['#f56a00', '#7265e6', '#ffbf00', '#00a2ae', '#712704', '#04477c', '#1291a9', '#000000', '#036803'];
...
var hasBinary = __webpack_require__(114);
var sliceBuffer = __webpack_require__(325);
var after = __webpack_require__(326);
var utf8 = __webpack_require__(327);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(328);
}
...
var Blob = __webpack_require__(329);
...
var hasBin = __webpack_require__(114);
var binary = __webpack_require__(318);
...
var hasCORS = __webpack_require__(322);
...
var baseHas = __webpack_require__(402),
...
var isArray = __webpack_require__(57),
    ...
    toString = __webpack_require__(437);
...
var eio = __webpack_require__(320);
...
var Backoff = __webpack_require__(335);
...
var XMLHttpRequest = __webpack_require__(70);
var XHR = __webpack_require__(323);
var JSONP = __webpack_require__(330);
var websocket = __webpack_require__(331);
...
module.exports = {
    ...
    //github OAuth
    githubClientID:  true ? "b794478ea18f28f30509" : "beb866b2260c1881c515",
    githubClientSecret:  true ? "e845cb85dae60b38dcab468d9d434b6e068ad083" : "1a0a83d40a110f3db587e134d585fe04bdf07736",

    chromium:  true ? "C:/Users/33318/AppData/Local/Chromium/Application/chrome.exe" : "beb866b2260c1881c515",
...
var arrayIndexOf = __webpack_require__(344)(false);
var IE_PROTO = __webpack_require__(77)('IE_PROTO');
...
var _ScrollNumber = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ChildrenUtils__ = __webpack_require__(376);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__AnimateChild__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__util__ = __webpack_require__(140);
...
var _toConsumableArray2 = __webpack_require__(444);
...
var _createReactClass = __webpack_require__(263);

var _createReactClass2 = _interopRequireDefault(_createReactClass);

var _asyncValidator = __webpack_require__(455);
...
var _has = __webpack_require__(88);
...
var _createFieldsStore = __webpack_require__(482);
...
var factory = __webpack_require__(454);
...
var baseSet = __webpack_require__(478);
...
var shallowEqual = __webpack_require__(485);
...
var _AsyncApp = __webpack_require__(337);

var _AsyncApp2 = _interopRequireDefault(_AsyncApp);

var _GithubReport = __webpack_require__(504);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouter.Route, { path: '/group', component: _AsyncApp2.default }),
						_react2.default.createElement(_reactRouter.Route, { path: '/githubReport', component: _GithubReport2.default }),
...
var _prismjs = __webpack_require__(308);
...
var _socket = __webpack_require__(311);
...
var socket = _socket2.default.connect({ secure: true });
// const socket = io();

// useStrict(true)
var TodoStore = (_class =
//是否显示代码编辑器
...
function TodoStore() {
	...
	_initDefineProp(this, "myInfo", _descriptor, this);

	_initDefineProp(this, "group", _descriptor2, this);

	_initDefineProp(this, "showRoomDetail", _descriptor3, this);

	_initDefineProp(this, "is_show_create_group_input", _descriptor4, this);

	_initDefineProp(this, "showEmoji", _descriptor5, this);

	_initDefineProp(this, "showCodeEdit", _descriptor6, this);

	_initDefineProp(this, "showMoreUserInfo", _descriptor7, this);

	_initDefineProp(this, "code", _descriptor8, this);

	_initDefineProp(this, "scrollToBottom", _descriptor9, this);

	_initDefineProp(this, "scrollToBottom", _descriptor10, this);

	_initDefineProp(this, "messageType", _descriptor11, this);

	_initDefineProp(this, "onlineUsers", _descriptor12, this);

	_initDefineProp(this, "doing", _descriptor13, this);

	_initDefineProp(this, "socket", _descriptor14, this);

	_initDefineProp(this, "allHold", _descriptor15, this);

	socket.on('get myInfo', function (json) {
		_this.myInfo = json;
		_this.initMyInfo = true;
	});
	socket.on('online user', function (json) {
		console.log('online user', json);
		_this.onlineUsers = json;
	});
	socket.on('init group', function (json) {
		if (!json) {
			_this.group.group_name = null;
			return;
		}
		_this.group = json;
		Prism.highlightAll();
	...
	socket.on('send message', function (json) {
		_this.group.messageList.push(json);
		Prism.highlightAll();
		_this.scrollToBottom = true;
	});

	socket.on('user detail', function (json) {
		console.log("user detail", json);
		//同时查询该用户star总数，
		fetch("" + json.github.repos_url).then(function (response) {
			return response.json();
		}).then(function (json) {
			json.map(function (repos, i) {
				_this.showMoreUserInfo.star_count += repos.stargazers_count;
			});
		}).then(function () {
			console.log('count', _this.showMoreUserInfo.star_count);
		});
		//只能一个一个获取，不然会改变 showmoreuserinfo 的框框xy坐标位置。
		_this.showMoreUserInfo.github = json.github;
		_this.showMoreUserInfo.groups = json.groups;
		_this.showMoreUserInfo.friends = json.friends;
		_this.showMoreUserInfo._id = json._id;
	});
}
//通用函数。。。
...
//是否显示用户详细信息
, (_descriptor = _applyDecoratedDescriptor(_class.prototype, "myInfo", [_mobx.observable], {
	enumerable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "group", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {
			_id: '',
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "showRoomDetail", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "is_show_create_group_input", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "showEmoji", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "showCodeEdit", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "showMoreUserInfo", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return {
			isShow: false,
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "code", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return '';
	}
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "scrollToBottom", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, "scrollToBottom", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor11 = _applyDecoratedDescriptor(_class.prototype, "messageType", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return 'text';
	}
}), _descriptor12 = _applyDecoratedDescriptor(_class.prototype, "onlineUsers", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return [];
	}
}), _descriptor13 = _applyDecoratedDescriptor(_class.prototype, "doing", [_mobx.observable], {
	enumerable: true,
	initializer: function initializer() {
		return false;
	}
}), _descriptor14 = _applyDecoratedDescriptor(_class.prototype, "socket", [_mobx.action], {
	enumerable: true,
	initializer: function initializer() {
...
}), _descriptor15 = _applyDecoratedDescriptor(_class.prototype, "allHold", [_mobx.action], {
	enumerable: true,
	initializer: function initializer() {
		var _this2 = this;
...
var url = __webpack_require__(312);
var parser = __webpack_require__(69);
...
exports.Manager = __webpack_require__(116);
...
var parseuri = __webpack_require__(313);
...
exports.humanize = __webpack_require__(316);
...
var parser = __webpack_require__(29);
var parseuri = __webpack_require__(333);
var parseqs = __webpack_require__(49);
...
Socket.Transport = __webpack_require__(71);
Socket.transports = __webpack_require__(117);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(119)(module), __webpack_require__(6)))
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(332);
  } catch (e) { }
}
...
var Canvas = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
        ...
        _createClass(Canvas, [{
                ...
                key: 'render',
                value: function render() {
                        return _react2.default.createElement('video', { className: 'window', autoPlay: true });
                }
        }]);
...
var _Sider = __webpack_require__(338);
...
var _UserDetails = __webpack_require__(385);

var _UserDetails2 = _interopRequireDefault(_UserDetails);

var _Trigger = __webpack_require__(386);
...
var AsyncApp = function AsyncApp(_ref) {
	var match = _ref.match;
	return _react2.default.createElement(
		_Trigger2.default,
		{ className: "container" },
		_react2.default.createElement(_Sider2.default, { match: match }),
		_react2.default.createElement(
			"div",
			{ className: "body" },
			...
			_react2.default.createElement(_reactRouterDom.Route, { path: match.url + "/:group_name", component: _Content2.default })
		),
...
var sider = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	...
	function sider() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = sider.__proto__ || Object.getPrototypeOf(sider)).call.apply(_ref, [this].concat(args))), _this), _this.add_group = function (e) {
			var _this$props$store = _this.props.store,
			    myInfo = _this$props$store.myInfo,
			    allHold = _this$props$store.allHold;
			...
			_this.props.store.socket({
				...
				group_name: _this.creat_group_input.value
			});
	...
	_createClass(sider, [{
		...
		value: function render() {
			...
			var _props$store = this.props.store,
			    ...
			    is_show_create_group_input = _props$store.is_show_create_group_input;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_badge2.default,
						{ dot: true, className: myInfo.status },
				...
				myInfo.groups.map(function (group, i) {
					return _react2.default.createElement(
						_reactRouterDom.Link,
						{
							key: i,
				...
				myInfo.user_id && _react2.default.createElement(
					'span',
					{ onClick: this.toggle, className: 'addgroup', id: 'addgroup' },
					_react2.default.createElement(_icon2.default, { type: 'usergroup-add' }),
					is_show_create_group_input ? _react2.default.createElement(
						'form',
						{ className: 'form', onSubmit: this.add_group },
						_react2.default.createElement('input', {
							ref: function ref(c) {
								return _this2.creat_group_input = c;
							},
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(72)(Function.call, __webpack_require__(137).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_css_animation__ = __webpack_require__(378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__util__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Event__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_component_classes__ = __webpack_require__(380);
...
"use strict";
throw new Error("Module build failed: SyntaxError: D:/WWW/chat/src/client/components/Header.jsx: Unexpected token, expected , (19:54)\n\n\u001b[0m \u001b[90m 17 | \u001b[39m\t\t\t\t\u001b[33m<\u001b[39m\u001b[33mspan\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"left\"\u001b[39m\u001b[33m>\u001b[39m\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mspan\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m 18 | \u001b[39m\t\t\t\t\u001b[33m<\u001b[39m\u001b[33mspan\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m\"title\"\u001b[39m\u001b[33m>\u001b[39m\n\u001b[31m\u001b[1m>\u001b[22m\u001b[39m\u001b[90m 19 | \u001b[39m\t\t\t\t\t{group\u001b[33m.\u001b[39mgroup_name\u001b[33m==\u001b[39m\u001b[36mnull\u001b[39m \u001b[33m?\u001b[39m \u001b[33m<\u001b[39m\u001b[33mh1\u001b[39m\u001b[33m>\u001b[39m房间不存在\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mh1\u001b[39m\u001b[33m>\u001b[39m \u001b[33m:\u001b[39m {group\u001b[33m.\u001b[39mgroup_name \u001b[33m==\u001b[39m \u001b[32m''\u001b[39m \u001b[33m?\u001b[39m \u001b[33m<\u001b[39m\u001b[33mh1\u001b[39m\u001b[33m>\u001b[39mgithub chat\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mh1\u001b[39m\u001b[33m>\u001b[39m \u001b[33m:\u001b[39m \u001b[33m<\u001b[39m\u001b[33mh1\u001b[39m className\u001b[33m=\u001b[39m\u001b[32m'toggleDetail'\u001b[39m\u001b[33m>\u001b[39m\n \u001b[90m    | \u001b[39m\t\t\t\t\t                                                 \u001b[31m\u001b[1m^\u001b[22m\u001b[39m\n \u001b[90m 20 | \u001b[39m\t\t\t\t\t\t{\u001b[32m`${group.group_name}(${group.memberList.filter(e => onlineUsers.indexOf(e.user_id) >= 0).length}/${group.memberList.length})人`\u001b[39m}\n \u001b[90m 21 | \u001b[39m\t\t\t\t\t\t{showRoomDetail \u001b[33m?\u001b[39m \u001b[33m<\u001b[39m\u001b[33mIcon\u001b[39m type\u001b[33m=\u001b[39m\u001b[32m\"up\"\u001b[39m \u001b[35m/> : <Icon type=\"down\" /\u001b[39m\u001b[33m>\u001b[39m}\n \u001b[90m 22 | \u001b[39m\t\t\t\t\t\u001b[33m<\u001b[39m\u001b[33m/\u001b[39m\u001b[33mh1\u001b[39m\u001b[33m>\u001b[39m)}\u001b[0m\n");
...
var UserDetails = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	...
	function UserDetails() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UserDetails.__proto__ || Object.getPrototypeOf(UserDetails)).call.apply(_ref, [this].concat(args))), _this), _this.mouseEnter = function () {
			_this.githubReport.scrollIntoView({
				behavior: 'smooth'
			});
		}, _this.mouseLeave = function () {
			_this.followers.scrollIntoView({
				behavior: "smooth"
			});
		}, _temp), _possibleConstructorReturn(_this, _ret);
	}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'span',
							_defineProperty({ className: 'message' }, 'className', 'nameContainer'),
							showMoreUserInfo.github.name
						),
						_react2.default.createElement(
							'a',
							{ className: 'github', target: '_blank', href: showMoreUserInfo.github.html_url },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							{
								ref: function ref(el) {
									_this2.githubReport = el;
								},
								className: 'githubReport' },
							'\u770B\u770B\u8FD9\u8D27\u7684Github\u5206\u6790\u62A5\u544A'
						)
					),
					showMoreUserInfo.github.bio && showMoreUserInfo.github.bio.length && _react2.default.createElement(
						'div',
						{ className: 'infoList' },
						_react2.default.createElement(
							'span',
						...
						_react2.default.createElement(
							'span',
							{ className: 'content' },
							showMoreUserInfo.github.bio
						)
					),
					showMoreUserInfo.github.location && showMoreUserInfo.github.location.length && _react2.default.createElement(
						'div',
						{ className: 'infoList' },
						_react2.default.createElement(
							'span',
						...
						_react2.default.createElement(
							'span',
							{ className: 'content' },
							showMoreUserInfo.github.location
						)
					),
					showMoreUserInfo.github.email && showMoreUserInfo.github.email.length && _react2.default.createElement(
						'div',
						{ className: 'infoList' },
						_react2.default.createElement(
							'span',
						...
						_react2.default.createElement(
							'a',
							{ className: 'content', href: 'mailto:' + showMoreUserInfo.github.email },
							showMoreUserInfo.github.email
						)
					),
					showMoreUserInfo.github.blog && showMoreUserInfo.github.blog.length && _react2.default.createElement(
						'div',
						{ className: 'infoList' },
						_react2.default.createElement(
							'span',
						...
						_react2.default.createElement(
							'a',
							{ className: 'content', target: '_blank', href: showMoreUserInfo.github.blog },
							showMoreUserInfo.github.blog
						)
					)
				)
			);
...
var Trigger = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	...
	function Trigger() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Trigger.__proto__ || Object.getPrototypeOf(Trigger)).call.apply(_ref, [this].concat(args))), _this), _this.handleAllEventClick = function (e) {
			...
			var _this$props$store = _this.props.store,
			    allHold = _this$props$store.allHold,
			    socket = _this$props$store.socket,
			...
			if (filterDOM('showMoreUserInfo')) {
				...
				socket({
					url: 'user detail',
					user_id: e.nativeEvent.path.filter(function (index) {
						e.preventDefault();
			...
			if (e.nativeEvent.path.filter(function (index) {
				...
				return e.id == 'contentRoomDetails' || e.id == 'showMoreUserInfoContainer';
			}).length > 0) {
				//
			} else {
...
var _momentTimezone = __webpack_require__(392);
...
var _SublimeText = __webpack_require__(395);

var _SublimeText2 = _interopRequireDefault(_SublimeText);

var _RoomDetails = __webpack_require__(503);
...
var content = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	...
	function content(props) {
		...
		_this.handleMsgSubmit = function (e) {
			var _this$props$store = _this.props.store,
			    myInfo = _this$props$store.myInfo,
			    group = _this$props$store.group,
			    scrollToBottom = _this$props$store.scrollToBottom,
			    allHold = _this$props$store.allHold;
		...
		_this.handleImage = function (e) {
			...
			input.addEventListener('change', function (e) {
				var form = new FormData();
				Array.from(e.target.files).filter(function (file) {
		...
		_this.scrollToBottom = function (data) {
			_this.messagesEnd.scrollIntoView(data);
		};
	...
	_createClass(content, [{
		...
		value: function componentDidMount() {
			var _props$store = this.props.store,
			    socket = _props$store.socket,
			    myInfo = _props$store.myInfo,
			    allHold = _props$store.allHold;
			var match = this.props.match;
		...
		value: function componentWillReceiveProps(nextProps) {
			var _props$store2 = this.props.store,
			    socket = _props$store2.socket,
			    allHold = _props$store2.allHold;
		...
		value: function render() {
			...
			var _props$store3 = this.props.store,
			    initMyInfo = _props$store3.initMyInfo,
			    scrollToBottom = _props$store3.scrollToBottom,
			    group = _props$store3.group,
			    allHold = _props$store3.allHold,
			    doing = _props$store3.doing,
			    myInfo = _props$store3.myInfo,
			    showEmoji = _props$store3.showEmoji;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'contentMessages' },
					doing && _react2.default.createElement(_spin2.default, { className: 'contentMessagesWait' }),
					group && group.messageList.map(function (post, i) {
						return _react2.default.createElement(
							'div',
							{ className: 'contentMessagesList ' + (post.user_name == myInfo.github.name ? 'me' : 'other'), key: i },
							_react2.default.createElement(_avatar2.default, {
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										(0, _momentTimezone2.default)(post.create_time).format('MMM Do , HH:mm:ss')
									)
								),
				...
				myInfo.github.name && _react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						...
						_client.emoji.split(' ').map(function (index, i) {
							return _react2.default.createElement(
								'span',
					...
					_react2.default.createElement(_icon2.default, { className: 'picture', type: 'picture', onClick: this.handleImage }),
					_react2.default.createElement(
						'span',
				...
				myInfo.github.name && _react2.default.createElement(
					'form',
					{ className: 'contentMessagesInputArea', onSubmit: function onSubmit(e) {
							e.preventDefault();
				...
				!myInfo.github.name && _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ href: 'https://github.com/login/oauth/authorize?client_id=' + _project2.default.githubClientID },
							'github'
						)
					)
				)
...
var _isCssAnimationSupported = __webpack_require__(389);
...
var _createDOMForm = __webpack_require__(398);

var _createDOMForm2 = _interopRequireDefault(_createDOMForm);

var _PureRenderMixin = __webpack_require__(267);
...
var _domScrollIntoView = __webpack_require__(399);
...
var _createBaseForm = __webpack_require__(262);

var _createBaseForm2 = _interopRequireDefault(_createBaseForm);

var _createForm = __webpack_require__(484);
...
var isFunction = __webpack_require__(416),
    ...
    toSource = __webpack_require__(419);
...
var _from = __webpack_require__(445);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__validator___ = __webpack_require__(456);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__messages__ = __webpack_require__(476);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__string__ = __webpack_require__(457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__method__ = __webpack_require__(463);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__number__ = __webpack_require__(464);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__boolean__ = __webpack_require__(465);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__regexp__ = __webpack_require__(466);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__integer__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__float__ = __webpack_require__(468);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__array__ = __webpack_require__(469);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__object__ = __webpack_require__(470);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__enum__ = __webpack_require__(471);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pattern__ = __webpack_require__(472);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__date__ = __webpack_require__(473);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__required__ = __webpack_require__(474);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__type__ = __webpack_require__(475);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__required__ = __webpack_require__(264);
...
var assignValue = __webpack_require__(479),
    castPath = __webpack_require__(89),
    isIndex = __webpack_require__(261),
    isObject = __webpack_require__(96),
    toKey = __webpack_require__(97);
...
var baseAssignValue = __webpack_require__(480),
    eq = __webpack_require__(260);
...
var defineProperty = __webpack_require__(481);
...
var fetchKeys = __webpack_require__(486);
...
var _Group = __webpack_require__(495);
	...
	_createClass(RoomDetails, [{
		...
		value: function render() {
			...
			var showRoomDetailListText = [{
				...
				title: '管理员',
				onlineUsers: [].concat(_toConsumableArray(group.administratorList.filter(function (e) {
					return onlineUsers.indexOf(e.user_id) >= 0;
				}))),
				offlineUsers: [].concat(_toConsumableArray(group.administratorList.filter(function (e) {
					return onlineUsers.indexOf(e.user_id) == -1;
				})))
			}, {
				title: '成员',
				onlineUsers: [].concat(_toConsumableArray(group.memberList.filter(function (e) {
					return onlineUsers.indexOf(e.user_id) >= 0;
				}))),
				offlineUsers: [].concat(_toConsumableArray(group.memberList.filter(function (e) {
					return onlineUsers.indexOf(e.user_id) == -1;
				})))
			}];
			return _react2.default.createElement(
				'div',
				{ id: 'contentRoomDetails', className: 'contentRoomDetails ' + (showRoomDetail ? 'show' : 'hide') },
				group && showRoomDetailListText.map(function (avatars, i) {
					return _react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							[].concat(_toConsumableArray(avatars.onlineUsers), _toConsumableArray(avatars.offlineUsers)).map(function (avatar, j) {
								return _react2.default.createElement(
									'span',
									{ className: 'avatar', key: j },
									_react2.default.createElement(
										_badge2.default,
										{ dot: true, className: '' + (j < avatars.onlineUsers.length ? "online" : 'offline') },
										_react2.default.createElement(_avatar2.default, {
...
var GithubReport = (_dec = (0, _mobxReact.inject)("store"), _dec(_class = (0, _mobxReact.observer)(_class = function (_Component) {
  _inherits(GithubReport, _Component);

  function GithubReport() {
    _classCallCheck(this, GithubReport);

    return _possibleConstructorReturn(this, (GithubReport.__proto__ || Object.getPrototypeOf(GithubReport)).apply(this, arguments));
  }

  _createClass(GithubReport, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
